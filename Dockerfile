...
RUN curl -s https://api.github.com/repos/tomwright/dasel/releases | grep v1.19.0 | grep browser_download_url | cut -d '"' -f 4 | wget -qi - && mv dasel_linux_amd64 dasel_v1_19_0 && chmod +x dasel_v1_19_0
RUN curl -s https://api.github.com/repos/tomwright/dasel/releases | grep v1.18.0 | grep browser_download_url | cut -d '"' -f 4 | wget -qi - && mv dasel_linux_amd64 dasel_v1_18_0 && chmod +x dasel_v1_18_0
RUN curl -s https://api.github.com/repos/tomwright/dasel/releases | grep v1.17.0 | grep browser_download_url | cut -d '"' -f 4 | wget -qi - && mv dasel_linux_amd64 dasel_v1_17_0 && chmod +x dasel_v1_17_0
RUN curl -s https://api.github.com/repos/tomwright/dasel/releases | grep v1.16.1 | grep browser_download_url | cut -d '"' -f 4 | wget -qi - && mv dasel_linux_amd64 dasel_v1_16_1 && chmod +x dasel_v1_16_1
RUN curl -s https://api.github.com/repos/tomwright/dasel/releases | grep v1.15.0 | grep browser_download_url | cut -d '"' -f 4 | wget -qi - && mv dasel_linux_amd64 dasel_v1_15_0 && chmod +x dasel_v1_15_0
RUN curl -s https://api.github.com/repos/tomwright/dasel/releases | grep v1.14.0 | grep browser_download_url | cut -d '"' -f 4 | wget -qi - && mv dasel_linux_amd64 dasel_v1_14_0 && chmod +x dasel_v1_14_0
...
RUN curl -s https://api.github.com/repos/tomwright/dasel/releases | grep v1.6.2 | grep browser_download_url | cut -d '"' -f 4 | wget -qi - && mv dasel_linux_amd64 dasel_v1_6_2 && chmod +x dasel_v1_6_2
RUN curl -s https://api.github.com/repos/tomwright/dasel/releases | grep v1.5.1 | grep browser_download_url | cut -d '"' -f 4 | wget -qi - && mv dasel_linux_amd64 dasel_v1_5_1 && chmod +x dasel_v1_5_1
RUN curl -s https://api.github.com/repos/tomwright/dasel/releases | grep v1.4.1 | grep browser_download_url | cut -d '"' -f 4 | wget -qi - && mv dasel_linux_amd64 dasel_v1_4_1 && chmod +x dasel_v1_4_1
