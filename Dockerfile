...
RUN curl -s https://api.github.com/repos/tomwright/dasel/releases | grep v1.9.0 | grep browser_download_url | cut -d '"' -f 4 | wget -qi - && mv dasel_linux_amd64 dasel_v1_9_0 && chmod +x dasel_v1_9_0
...
ENV DASEL_BUILDS="${DASEL_BUILDS},v1.9.0:./builds/dasel_v1_9_0"
